...
## Image Comparison
	...
	testdata/splash128.png
	testdata/splash16.png
	testdata/splash256.png
	testdata/splash32.png
	testdata/splash64.png
	testdata/splash8.png
	testdata/splash_standard256.png

The palettes are generated by palgen

| truecolor | 8 color palette | 16 color palette | 32 color palette | 64 color palette | 128 color palette | 256 color palette |
| --------------------------------- | -------------------------------- |-------------------------------- |-------------------------------- |-------------------------------- |-------------------------------- |-------------------------------- |
