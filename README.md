...
`palgen` can also be used for rendering palettes to images. Here are the two built-in palettes in the Go standard library, with the colors sorted:

#### [Plan9](https://golang.org/pkg/image/color/palette/#Plan9)

| Original | Sorted |
| :---: | :---: |
| ![png](img/plan9_unsorted.png) | ![png](img/plan9.png) |

#### [WebSafe](https://golang.org/pkg/image/color/palette/#WebSafe)

| Original | Sorted |
| :---: | :---: |
| ![png](img/websafe_unsorted.png) | ![png](img/websafe.png) |
