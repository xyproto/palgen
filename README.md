...
As far as I am aware, this is a unique algorithm that has not been used or implemented before (create an issue if not), so I'll hereby name it "Rødseth's Median Intensity Algorithm".
